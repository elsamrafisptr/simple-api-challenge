...
class Configs(BaseSettings):
    ...
    FIREBASE_CREDENTIALS: str = os.getenv("FIREBASE_CREDENTIALS", "your_firebase_credentials")
    FIREBASE_PROJECT: str = os.getenv("FIREBASE_PROJECT", "your_firebase_project")
